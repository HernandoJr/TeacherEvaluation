...
<body>
	...
	<table>
		<table>
			<tr>
			<th class="headertable" ><p class="title">EVALUATEE INFORMATION:</p><p class="name">Teachers Name:&nbsp;Mr. Mark Nolledo<p class="name">
			<hr>
			<p class="name">Course Code: COSCI105-LAB</P>
